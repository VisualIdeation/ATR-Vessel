/***********************************************************************
SimpleMCNP - Example class demonstrating how to write new modules for
...
#ifndef VISUALIZATION_CONCRETE_SIMPLEMCNP_INCLUDED
#define VISUALIZATION_CONCRETE_SIMPLEMCNP_INCLUDED
...
class SimpleMCNP:public BaseModule
	{
	/* Constructors and destructors: */
	public:
	SimpleMCNP(void); // Default constructor
